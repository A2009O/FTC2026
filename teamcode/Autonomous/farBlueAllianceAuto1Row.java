...
@Autonomous
public class farBlueAllianceAuto1Row extends OpMode {
    ...
    private final Pose intakePose = new Pose(12.186916327102804, 33, Math.toRadians(180));
    private final Pose intakeCurve = new Pose(71.96635514018692, 35.822429906542055);
