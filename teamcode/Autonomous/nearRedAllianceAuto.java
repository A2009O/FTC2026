...
@Autonomous
public class nearRedAllianceAuto extends OpMode {
    ...
    private final Pose startPose  = new Pose(128.70841121495328, 115.65700934579438, Math.toRadians(39));
    private final Pose shootPose  = new Pose(95.14657341378128,  79.65944430374081, Math.toRadians(0));
    private final Pose intake1Pose= new Pose(127.82242990654206, 81.7476635514019,  Math.toRadians(0));
    private final Pose intake2Curve = new Pose(78.50467289719626, 53.831775700934585);
    private final Pose intake2Pose= new Pose(133.15887850467288, 54.6355140186916, Math.toRadians(0));
    private final Pose gateIntake = new Pose(138.97570093457944, 55.13551401869161, Math.toRadians(16));
    ...
    public void loop() {
        ...
        targetVelocity = 3824.327 -
                (119.6856*distance) +
                (1.844784*distance*distance) -
                (0.01169042*distance*distance*distance) +
                (0.00002677505*distance*distance*distance*distance);
