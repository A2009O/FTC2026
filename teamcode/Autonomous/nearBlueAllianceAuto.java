...
public class nearBlueAllianceAuto extends OpMode {
    ...
    private final Pose intake1Pose= new Pose(16.177570093457943,   81.7476635514019,  Math.toRadians(180));
    private final Pose intake2Curve = new Pose(65.49532710280374,   53.831775700934585);
    private final Pose intake2Pose= new Pose(10.841121495327103,  54.6355140186916, Math.toRadians(180));
    private final Pose gateIntake = new Pose(4.02429906542056,   55.13551401869161, Math.toRadians(158));
