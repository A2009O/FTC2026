...
@Autonomous
public class farRedAllianceAuto0Rows extends OpMode {
    ...
    public enum PathState {
        ...
        SHOOT_PRELOAD1,
        DRIVE_SHOOTPOS_HUMANPOS0,
        DRIVE_HUMANPOS_SHOOTPOS0,
        SHOOT_PRELOAD2,
    ...
    private final Pose humanPose = new Pose(134.58878504672896, 8.299065420560762, Math.toRadians(0));
    ...
    private PathChain driveStartPosShootPos, driveShootPosHumanPos0, driveHumanPosShootPos0,
            ...
            driveShootPosHumanPos3, driveHumanPosShootPos3, driveShootPosEndPos;
        ...
        switch (pathState) {
            ...
            case SHOOT_PRELOAD1:
                ...
                if (shotStarted && !shooter.isBusy()) {
                    shotStarted = false;
                    setPathState(PathState.DRIVE_SHOOTPOS_HUMANPOS0);
                }
                break;

            case DRIVE_SHOOTPOS_HUMANPOS0:
                if (pathTimer.getElapsedTimeSeconds() < 0.1) {
                    follower.followPath(driveShootPosHumanPos0, true);
                }
            ...
            case DRIVE_HUMANPOS_SHOOTPOS0:
                if (pathTimer.getElapsedTimeSeconds() < 0.1) {
                    shooter.setPause();
                    follower.followPath(driveHumanPosShootPos0, true);
                }
