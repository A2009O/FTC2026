...
public class RedAllianceTeleOp extends OpMode{
    ...
    public void init() {
        ...
        if(RobotMemory.autoEndPose != null) {
            follower.setStartingPose(new Pose((RobotMemory.autoEndPose.getPose().getX() + 2.577570093457946),
                    (RobotMemory.autoEndPose.getPose().getY() - 3.81962616822432),
                    (RobotMemory.autoEndPose.getPose().getHeading() + 0.05235987756))); // Last number is 3 in radians
        }
        else{
            follower.setStartingPose(new Pose(90.474766355140186,
                    108.15233644859812,
                    Math.toRadians(3)));
        }
    ...
    public void loop() {
        ...
        if(gamepad1.dpadUpWasPressed()) reset();
        ...
        double headingRad = follower.getTotalHeading() - headingOffset;
    ...
    public void reset() {
        ...
        headingOffset = follower.getTotalHeading() - Math.toRadians(3);
    }
}
