...
public class farBlueAllianceAuto extends OpMode {
    ...
    private final Pose humanCurve = new Pose(33.691264483033116, 31.724844482443473);
    private final Pose humanPose = new Pose(5.41121495327104, 4.299065420560762, Math.toRadians(205));
